...
// web/app.ts
var DB_NAME = "GroqChatDB";
var DB_VERSION = 1;
var STORE_NAME = "conversations";
...
var saveKeyBtn = document.getElementById("save-api-key-btn");
...
var currentChatTitle = document.getElementById("current-chat-title");
...
function renderMessage(msg) {
  ...
  const rawHtml = d.parse(msg.content);
...
async function updateChat(id, messages, title) {
  ...
  if (id === currentChatId) renderHistory();
}
        ...
        for (const line of lines) {
          if (line.startsWith("data: ") && line !== "data: [DONE]") {
            try {
              ...
              fullResponse += delta;
              contentDiv.innerHTML = purify.sanitize(d.parse(fullResponse));
              messagesContainer.scrollTop = messagesContainer.scrollHeight;
            } catch (e) {
